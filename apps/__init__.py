# coding: utf-8
# 📂 apps/__init__.py - المصنع السيادي الموحد (نسخة محسنة لتجاوز أخطاء البناء)
...
def create_app():
    ...
    # 5. 🚀 ميكانيكية الاكتشاف التلقائي (محصنة)
    ...
    # 6. تعديل جوهري لتجنب خطأ BuildError
    @app.route('/')
    def index():
        # استخدام رابط مطلق صريح بدلاً من الاعتماد على url_for الذي قد يفشل أثناء التسجيل الديناميكي
